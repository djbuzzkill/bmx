...
namespace af {
  ...
  namespace hex {
    ...
    //
    // create base58 from binary
    std::string& encode (std::string& outBE, const void* bin_BE, size_t len) {
    ...
    //
    // create binary from base58 encoding
    void* decode (void* outBE, size_t len, const std::string& str) {
  ...
  namespace base58 {
    ...
    std::string& encode (std::string& out, const void* inBE, size_t len, bool isBE)  {
    ...
    void* decode (void* outBE, size_t olen,  const std::string& ) {
